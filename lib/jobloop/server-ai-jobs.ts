...
- 这是候选人投递简历时发给 HR 的**打招呼话术**，必须以候选人第一人称撰写，面向招聘方 HR。
- 格式：简短自我介绍（姓名可用"我"代替）+ 对岗位的兴趣 + 2-3 个核心匹配点（结合简历亮点和 JD 要求，具体而非泛泛）+ 表达进一步沟通意愿。
- 语气专业、自信、简洁，150-200 字，不要以"JobLoop"或"求职顾问"身份说话，不要出现"建议您"这类指导性语句。
- 示例风格："您好，我对贵司XX岗位很感兴趣。我有X年YY经验，曾主导ZZ项目并取得AA成果。我的BB技能与贵司CC要求高度契合。希望能有机会深入交流！"
